          ...
          <div className="w-full max-w-4xl bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-2xl">
            <div className="flex items-center justify-between px-6 py-3 border-b border-slate-800 bg-slate-950/80">
              <div className="flex items-center gap-2">
                <span className="text-xs font-black uppercase text-rose-500 font-mono">ANIMEM.UZ PLEER</span>
                <span className="text-xs text-slate-400 font-bold truncate max-w-md">
                  — {selectedVideoForPlay.anime_title} ({selectedVideoForPlay.episode_number}-qism)
                </span>
              </div>
              <button
            ...
            <div className="aspect-video w-full bg-black">
              <AnimemPlayer video={selectedVideoForPlay} autoplay={true} />
            </div>
          </div>
        </div>
      )}
